...
try:
    model = load_model(r'G:\PROJECTS\NLP\chatbot\trained_model.keras')
except:
    print('can\'t find: trained_model.keras')
    sys.exit(0)
try:
    intents = json.loads(open(r'G:\PROJECTS\NLP\chatbot\intents.json').read())
except:
    print('can\'t find: intents.json')
    sys.exit(0)
try:
    words = pickle.load(open(r'G:\PROJECTS\NLP\chatbot\words.pkl', 'rb'))
except:
    print('can\'t find: words.pkl')
    sys.exit(0)
try:
    classes = pickle.load(open(r'G:\PROJECTS\NLP\chatbot\classes.pkl', 'rb'))
except:
